...
- <a href="https://github.com/AuxXxilium/arc-automated">Arc Automated</a> is a new customized Redpill Loader for DSM 7.x (Xpenology) with enhanced Hardwaresupport, Addons and full-automated Installation. No user interaction required but has user customization options. Recommended for User that have no access to the Machine (Datacenter).
